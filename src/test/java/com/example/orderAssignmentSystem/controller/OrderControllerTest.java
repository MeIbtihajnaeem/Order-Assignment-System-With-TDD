...
//	private static final Worker DEFAULT_WORKER = new Worker("BOB", DEFAULT_WORKER_CodiceFiscale);
...
////
////		when(workerRepository.findByCodiceFiscale(DEFAULT_WORKER_CodiceFiscale))
////				.thenReturn(new Worker("Alic", DEFAULT_WORKER_CodiceFiscale));
////
...
////		inOrder.verify(workerRepository).findByCodiceFiscale(DEFAULT_WORKER_CodiceFiscale);
